...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { path: '/calls', label: 'Call Log', icon: Phone, page: 'CallLog' },
    { path: '/leads', label: 'Leads', icon: Users, page: 'Leads' },
    { path: '/orders', label: 'Orders', icon: ShoppingCart, page: 'Orders' },
    { path: '/master', label: 'Master Data', icon: Settings, page: 'MasterData' },
  ];
